...
MeScroll.prototype.extendDownScroll = function(a) {
    MeScroll.extend(a, {
        ...
        inited: function(c, b) {
            ...
            c.downProgressDom = b.getElementsByClassName(
                "downwarp-progress"
            )[0];
        },
        inOffset: function(b) {
        ...
        onMoving: function(c, e, b) {
            if (c.downProgressDom) {
                var d = 360 * e;
                c.downProgressDom.style.webkitTransform =
                    "rotate(" + d + "deg)";
...
MeScroll.prototype.initDownScroll = function() {
        ...
        if (d > 0) {
            if (c <= 0) {
                ...
                if (
                    ...
                    !b.isDownScrolling &&
                    !b.optDown.isLock &&
                    (!b.isUpScrolling || (b.isUpScrolling && b.optUp.isBoth))
                ) {
            ...
            if (d < 0) {
                ...
                if (
                    ...
                    !b.isUpScrolling &&
                    (!b.isDownScrolling ||
                        (b.isDownScrolling && b.optDown.isBoth)) &&
                    (i + b.optUp.offset >= p || h <= 0)
                ) {
                    b.triggerUpScroll();
                }
            }
    ...
    if (b.optDown.use) {
        ...
        b.downwarp.innerHTML =
            '<div class="downwarp-content">' + b.optDown.htmlContent + "</div>";
...
MeScroll.prototype.initUpScroll = function() {
    ...
    b.scrollEvent = function() {
        ...
        if (
            !b.isUpScrolling &&
            (!b.isDownScrolling || (b.isDownScrolling && b.optDown.isBoth))
        ) {
    ...
    while (c !== document.body && c !== document) {
        ...
        if (l) {
            if (l.contains("mescroll") || l.contains("mescroll-touch")) {
                ...
                if (
                    l.contains("mescroll-touch-x") ||
                    l.contains("mescroll-touch-y")
                ) {
                    ...
                    if (h != 0) {
                        ...
                        if (
                            (f <= 45 && l.contains("mescroll-touch-x")) ||
                            (f > 45 && l.contains("mescroll-touch-y"))
                        ) {
                            d = false;
                            break;
                        }
...
MeScroll.prototype.loadFull = function() {
    var a = this;
    if (
        a.optUp.loadFull.use &&
        !a.optUp.isLock &&
        a.optUp.hasNext &&
        a.getScrollHeight() <= a.getClientHeight()
    ) {
        setTimeout(function() {
