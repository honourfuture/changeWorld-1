...
const Utils={
    ...
    numberToChinese:function(number){
        const a=(number+'').split(''),s=[],t=this,j=a.length-1;
        if(a.length>12){
...
class VanityItem extends BaseComponent {
    render(){
        ...
        const numLast = pretty_id.toString().slice(4,pretty_id.toString().length);
        return(
        ...
        return (
            <div className='Vanity base-content'>
                ...
                <div className="vanity-num">
                	<Tabs tabs={tabs} swipeable={false} onChange={this.onChange}>
