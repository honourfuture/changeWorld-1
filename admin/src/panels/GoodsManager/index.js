...
export default class GoodsManager extends BaseComponent {
    ...
    constructor(props) {
        ...
        this.columns = [
            ...
            },
            {
                ...
                render: (text, record) =>
                    this.renderSelect(text, record, "goods_class_id")
            },
            {
                title: "库存",
                dataIndex: "stock",
    ...
    renderStoreInfo(text, record, column) {
        ...
        return <div>{user[seller_uid] ? user[seller_uid].nickname : ""}</div>;
    }
    ...
    onDelete(id) {
        Base.POST(
            { act: "goods", op: "save", id, deleted: "1" },
