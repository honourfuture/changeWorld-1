...
import "./LiveClass.less";
const Search = Input.Search;

export default class LiveClass extends BaseComponent {
    store = {
        list: [],
        searchStr: ""
    };
    ...
    onDelete(id) {
        Base.POST(
            { act: "live_class", op: "save", id, deleted: "1" },
    ...
    render() {
        ...
        return (
            <Spin ref="spin" wrapperClassName="LiveClass" spinning={false}>
                <div className="pb10">
