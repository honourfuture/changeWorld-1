...
export default class ShopManager extends BaseComponent {
    store = {
        list: [],
        article_class: []
    };
    ...
    constructor(props) {
        ...
        this.columns = [
            ...
            },
            {
                ...
                width: "15%",
                render: (text, record) =>
                    this.renderSelect(text, record, "article_class_id")
            },
            {
                title: "启用",
                dataIndex: "enable",
    ...
    renderSelect(text, record, column) {
        ...
        return (
            <div>
                {record.editable ? (
                    <Select
                        defaultValue={value || article_class[0].id}
                        style={{ width: 120 }}
                        onChange={value =>
                            this.onEditChange(record.id, value, column)
                        }
                    >
                        {article_class.map(({ id, name }) => (
    ...
    onDelete(id) {
        Base.POST(
            { act: "article", op: "save", id, deleted: "1" },
    ...
    onAdd() {
        ...
        const article_class_id =
            article_class.length > 0 ? article_class[0].id : "";
    ...
    render() {
        ...
        return (
            <Spin ref="spin" wrapperClassName="ShopManager" spinning={false}>
                <div className="pb10">
