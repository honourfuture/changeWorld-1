...
export class PointRuleSet extends BaseComponent {
    store = {
        list: []
    };
    constructor(props) {
        ...
        this.columns = [
            {
                title: "名称",
                dataIndex: "show_name", render: (text, record) =>
    ...
    onSave(id) {
        ...
        Base.POST(
            { act: "points_rule", op: "save", mod: "admin", ...itemData },
            res => {
    ...
    onDelete(id) {
        Base.POST(
            { act: "points_rule", op: "save", mod: "admin", id, deleted: "1" },
