define({ "api": [
  ...
  {
    "type": "post",
    "url": "/api/activity_class/save",
    "title": "活动类-编辑 OR 新增",
    "version": "1.0.0",
    "name": "activity_class_save",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/activity_class/save"
  ...
  {
    "type": "post",
    "url": "/api/admin/activity/recommend",
    "title": "活动-推荐设置",
    "version": "1.0.0",
  ...
  {
    "type": "post",
    "url": "/api/admin/admin_role/access",
    "title": "管理员角色-权限设置",
    "version": "1.0.0",
  ...
  {
    "type": "post",
    "url": "/api/admin/admin_role/save",
    "title": "管理员角色-编辑 OR 新增",
    "version": "1.0.0",
    "name": "admin_role_save",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/admin/admin_role/save"
  ...
  },
  {
    ...
    "filename": "application/controllers/api/admin/Rank_rule.php",
    "groupTitle": "admin"
  },
  {
    "type": "get",
    ...
    "filename": "application/controllers/api/user/Rank_rule.php",
    "groupTitle": "admin"
  },
  {
    "type": "get",
    "url": "/api/admin/sign_setting",
    "title": "签到设置列表",
    "version": "1.0.0",
    "name": "grade_rule",
    "group": "admin",
    ...
    "filename": "application/controllers/api/admin/Sign_setting.php",
    "groupTitle": "admin"
  },
  {
    "type": "post",
    "url": "/api/users_rank_rule_verify/upgrade",
    "title": "用户等级-升级",
    "version": "1.0.0",
    ...
    "filename": "application/controllers/api/Users_rank_rule_verify.php",
    "groupTitle": "admin"
  },
  {
    "type": "post",
  ...
  {
    "type": "post",
    "url": "/api/admin/sign_setting/save",
    "title": "等级经验规则-编辑 OR 新增",
    "version": "1.0.0",
    "name": "grade_rule_save",
    "group": "admin",
  ...
  {
    "type": "post",
    "url": "/api/admin/grade_level/save",
    "title": "会员等级设置-编辑 OR 新增",
    "version": "1.0.0",
    "name": "grade_save",
    "group": "admin",
    "sampleRequest": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "brokerage",
            "description": "<p>自购佣金</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "direct_brokerage",
            "description": "<p>直属代理佣金</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "under_gt_brokerage",
            "description": "<p>会员等级大于下属</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "under_eq_brokerage",
            "description": "<p>会员等级等于下属最高</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "under_lt_brokerage",
            "description": "<p>会员等级小于下属最高</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  {
    "type": "post",
    "url": "/api/admin/headhunter/onoff",
    "title": "猎头用户-开关",
    "version": "1.0.0",
    "name": "headhunter_onoff",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/admin/headhunter/onoff"
  ...
  {
    "type": "post",
    "url": "/api/admin/push/save",
    "title": "系统极光推送-编辑 OR 新增",
    "version": "1.0.0",
    "name": "push_save",
    "group": "admin",
    "sampleRequest": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>模块唯一ID ['主播ID', '音频ID', '专辑ID', '活动ID', '直播间ID']</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
          ...
          },
          {
            ...
            "optional": false,
            "field": "step_num",
            "description": "<p>变动值 支持格式： 5 或者 10-99</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
          ...
          },
          {
            ...
            "optional": false,
            "field": "range",
            "description": "<p>浮动范围 支持格式： 10-99</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/api/admin/robot/header_batch_add",
    "title": "机器人-头像批上传",
    "version": "1.0.0",
    "name": "robot_header_batch_add",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/admin/robot/header_batch_add"
  ...
  {
    "type": "get",
    "url": "/api/admin/robot/header_list",
    "title": "机器人-头像列表",
    "version": "1.0.0",
    "name": "robot_header_list",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/admin/robot/header_list"
  ...
  {
    "type": "post",
    "url": "/api/admin/robot/nickname_import",
    "title": "机器人-昵称导入",
    "version": "1.0.0",
    "name": "robot_nickname_import",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/admin/robot/nickname_import"
  ...
  {
    "type": "get",
    "url": "/api/admin/robot/nickname_list",
    "title": "机器人-昵称列表",
    "version": "1.0.0",
    "name": "robot_nickname_list",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/admin/robot/nickname_list"
  ...
  {
    "type": "post",
    "url": "/api/admin/robot/users_random",
    "title": "机器人-生成",
    "version": "1.0.0",
    "name": "robot_users_random",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/admin/robot/users_random"
  ...
  {
    "type": "post",
    "url": "/api/admin/shop/reward_point",
    "title": "店铺管理-消费返积分开关",
    "version": "1.0.0",
    "name": "shop_reward_point",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/admin/shop/reward_point"
  ...
  {
    "type": "get",
    "url": "/api/team_management/super_and_child",
    "title": "团队管理-获取用户的直接上级与直接下级列表",
    "version": "1.0.0",
    "name": "super_and_child",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/team_management/super_and_child"
    ...
    "filename": "application/controllers/api/Team_Management.php",
    "groupTitle": "admin"
  },
  {
    "type": "get",
    "url": "/api/team_management/get_child",
    "title": "团队管理-显示用户下级总人数及列表",
    "version": "1.0.0",
    "name": "team_management_child",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/team_management/get_child"
  ...
  {
    "type": "get",
    "url": "/api/admin/user/super_and_child",
    "title": "根据手机号与id 获取用户的直接上级与直接下级列表",
    "version": "1.0.0",
    "name": "user_view",
    "group": "admin",
    "sampleRequest": [
  ...
  {
    "type": "get",
    "url": "/api/admin/user/get_child",
    "title": "根据手机号与id 显示用户下级总人数及列表",
    "version": "1.0.0",
    "name": "user_view",
    "group": "admin",
    "sampleRequest": [
  ...
  {
    "type": "get",
    "url": "/api/admin/users_rank_rule_verify",
    "title": "获取用户等级表",
    "version": "1.0.0",
    "name": "users_rank_rule_verify",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/admin/users_rank_rule_verify"
    ...
    "filename": "application/controllers/api/admin/Users_rank_rule_verify.php",
    "groupTitle": "admin"
  },
  {
    "type": "post",
    "url": "/api/admin/users_rank_rule_verify/save",
    "title": "审核",
    "version": "1.0.0",
    "name": "users_rank_rule_verify_save",
    "group": "admin",
    "sampleRequest": [
      {
        "url": "/api/admin/users_rank_rule_verify/save"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "status",
            "description": "<p>1 审核中 2 审核通过 3 审核拒绝</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "activity_class_id",
            "description": "<p>活动分类ID 0表示热门</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "Object[]",
            "optional": false,
            "field": "data.recommend",
            "description": "<p>推荐活动列表</p>"
          },
          {
            "group": "Success 200",
            "type": "Object[]",
  ...
  {
    "type": "post",
    "url": "/api/activity_enter/add",
    "title": "活动-报名",
    "version": "1.0.0",
    "name": "activity_enter_add",
    "group": "api",
    "sampleRequest": [
      {
        "url": "/api/activity_enter/add"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "photos",
            "description": "<p>个人展示图 [{'url':'', 'width':'400', 'height':600}]</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "rank",
            "description": "<p>排行 0默认详情页更多 1选手排行</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "filename": "application/controllers/api/Crontab.php",
    "groupTitle": "api"
  },
  {
    "type": "get",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "data.level.rule",
            "description": "<p>权益说明</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "data.level.icon",
            "description": "<p>图标</p>"
          },
          {
            "group": "Success 200",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "Object",
            "optional": false,
            "field": "data.activity_user",
            "description": "<p>活动发起人信息</p>"
          },
          {
            "group": "Success 200",
            "type": "Object",
  ...
  {
    "type": "post",
    "url": "/api/users_grade/add",
    "title": "经验值-增加",
    "version": "1.0.0",
    "name": "users_grade_add",
    "group": "api",
    "sampleRequest": [
      {
        "url": "/api/users_grade/add"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>涨经验类型[live:开播, live_view:听直播, audio:听音频]</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/api/users_points/todayPoint",
    "title": "今日积分",
    "version": "1.0.0",
    "name": "users_points_todayPoint",
    "group": "api",
    "sampleRequest": [
      {
        "url": "/api/users_points/todayPoint"
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "data.today.count",
            "description": "<p>积分上线</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "data.today.value",
            "description": "<p>已增加积分</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "data.today.remark",
            "description": "<p>名称</p>"
          }
        ]
      },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "data.rule",
            "description": "<p>会员权益说明</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "data.brokerage",
            "description": "<p>自购佣金 百分比</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "data.grade_demand",
            "description": "<p>会员门槛</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "data.direct_brokerage",
            "description": "<p>直属代理佣金</p>"
          },
          {
            "group": "Success 200",
  ...
  {
    "type": "post",
    "url": "/api/change_bind/changByPassword",
    "title": "修改绑定-根据密码",
    "version": "1.0.0",
    "name": "chang_by_password",
    "group": "changeBin",
    "sampleRequest": [
      {
        "url": "/api/change_bind/changByPassword"
  ...
  {
    "type": "post",
    "url": "/api/change_bind/releaseThree",
    "title": "修改绑定-删除第三方绑定",
    "version": "1.0.0",
    "name": "change_bind_release_three",
    "group": "changeBin",
    "sampleRequest": [
      {
        "url": "/api/change_bind/releaseThree"
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "data.countSignIn",
            "description": "<p>总签到天数</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
          ...
          },
          {
            ...
            "optional": false,
            "field": "data.list.point",
            "description": "<p>获取的积分</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "data.list.continue",
            "description": "<p>连续签到天数大于0为签到</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "prize",
            "description": "<p>奖项 json [{'goods_id':100, 'name':'一等奖', 'num':10}]</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  {
    "type": "get",
    "url": "/api/user/income/distribution",
    "title": "收益明细-我是",
    "version": "1.0.0",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "data.user.invite_url",
            "description": "<p>邀请链接</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "data.user.invite_user_id",
            "description": "<p>邀请人id</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "data.user.invite_user_header",
            "description": "<p>邀请人昵称</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "data.user.invite_user_nickname",
            "description": "<p>邀请人头像</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "post",
    "url": "/api/user/info/bind_device_uuid",
    "title": "用户信息-绑定极光registration_id",
    "version": "1.0.0",
    "name": "info_bind_device_uuid",
    "group": "user",
    "sampleRequest": [
      {
        "url": "/api/user/info/bind_device_uuid"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "invite_code",
            "description": "<p>邀请码，实例：1234567</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "act",
            "description": "<p>操作动作 [修改密码:password, 支付密码:pay_password, 头像:header, 昵称:nickname, 性别:sex 0保密 1男 2女, 出生日期:birth 2018-01-12, 简介:summary, 地址:address（省市区名称），背景图：bg_image，邀请人绑定：invite_code]</p>"
          }
        ]
      }
    },
    "description": "<p>password传递参数: old_password,new_password,confirm_password pay_password传递参数: pay_password,confirm_password header传递参数：header nickname传递参数：nickname sex传递参数：sex birth传递参数：birth 接口返回age summary传递参数：summary address传递参数：address bg_image传递参数：bg_image</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "is_point",
            "description": "<p>是否支持积分抵扣0 不支持 1 支持</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "is_point",
            "description": "<p>是否支持积分抵扣 0 不支持 1 支持</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "area",
            "description": "<p>省市区 英文逗号分割 我的加盟商不用传，城市合伙人必传</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/api/user/info/ironfans",
    "title": "我的铁粉-列表",
    "version": "1.0.0",
    "name": "partner_ironfans",
    "group": "user",
    "sampleRequest": [
      {
        "url": "/api/user/info/ironfans"
  ...
  {
    "type": "post",
    "url": "/api/user/partner/member_add",
    "title": "推荐人-添加",
    "version": "1.0.0",
    "name": "partner_member_add",
    "group": "user",
    "sampleRequest": [
      {
        "url": "/api/user/partner/member_add"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>分销类型 0城市合伙人 1加盟商</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "project",
            "description": "<p>我的XXX 我是XXX（默认：0） 0：我的 1：我是</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "payment_type",
            "description": "<p>支付类型 balance：余额 wechat：微信 alipay：支付宝 point: 积分</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  {
    "type": "post",
    "url": "/api/user/room_action/add",
    "title": "直播间操作集合-添加",
    "version": "1.0.0",
    "name": "room_action_add",
    "group": "user",
    "sampleRequest": [
      {
        "url": "/api/user/room_action/add"
  ...
  {
    "type": "post",
    "url": "/api/user/room_action/del",
    "title": "直播间操作集合-删除",
    "version": "1.0.0",
    "name": "room_action_del",
    "group": "user",
    "sampleRequest": [
      {
        "url": "/api/user/room_action/del"
  ...
  {
    "type": "post",
    "url": "/api/user/room_control/add",
    "title": "场控-添加",
    "version": "1.0.0",
    "name": "room_control_add",
    "group": "user",
    "sampleRequest": [
      {
        "url": "/api/user/room_control/add"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "room_control_user_id",
            "description": "<p>选择场控账号ID</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/api/user/room_control/check",
    "title": "主播场控判断",
    "version": "1.0.0",
    "name": "room_control_check",
    "group": "user",
    "sampleRequest": [
      {
        "url": "/api/user/room_control/check"
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "data.is_room_control",
            "description": "<p>场控判断 0否 1是</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "post",
    "url": "/api/user/room_control/del",
    "title": "场控-删除",
    "version": "1.0.0",
    "name": "room_control_del",
    "group": "user",
    "sampleRequest": [
      {
        "url": "/api/user/room_control/del"
  ...
  {
    "type": "get",
    "url": "/api/user/room_control/search",
    "title": "场控-添加搜索",
    "version": "1.0.0",
    "name": "room_control_search",
    "group": "user",
    "sampleRequest": [
      {
        "url": "/api/user/room_control/search"
