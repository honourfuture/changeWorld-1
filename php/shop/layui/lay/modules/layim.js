...
layui
    .define(["layer", "laytpl", "upload"], function(i) {
        ...
        (c.prototype.config = function(i) {
            ...
            if (
                ...
                (i.skin = a),
                (i = e.extend(
                    { isfriend: !0, isgroup: !0, voice: "default.mp3" },
                    i
                )),
            ...
            (c.prototype.setFriendStatus = function(i, a) {
                ...
                t["online" === a ? "removeClass" : "addClass"](
                    "layim-list-gray"
                );
            }),
        ...
        var x,
                ...
                return t.open({
                    ...
                    success: function(i) {
                        (x = i),
                            R(i),
                            j.base.right &&
                                i.css("margin-left", "-" + j.base.right),
            ...
            A = function() {
                ...
                x.find(".layim-list-history").on("contextmenu", "li", function(
                    a
                ) {
                    var n = e(this),
                        l =
                    ...
                    (N.index = t.open({
                        ...
                        success: function(a, l) {
                            i || (k = a),
                                ...
                                a
                                    .find(".layui-layer-content span")
                                    .on("click", function() {
                                        t.close(l),
                                            i
                                                ? layui.each(j.chat, function(
                                                      i,
                                                      a
                                                  ) {
                                                      z(a);
                    ...
                    (M.index = t.open({
                        ...
                        content: n(p).render({
                            data: {
                                ...
                                group:
                                    i.group ||
                                    parent.layui.layim.cache().friend ||
                                    [],
                                type: i.type
                            },
                            type: a
            ...
            _ = (c.prototype.thisChat = function() {
                if (w) {
                    var i = e(".layim-chat-list ." + o).index(),
                        ...
                        t = JSON.parse(
                            decodeURIComponent(
                                a.find(".layim-chat-tool").data("json")
                            )
                        );
            ...
            K = function(i) {
                ...
                if (
                    ...
                    if (j.message[i.type + i.id])
                        ...
                        ((j.message[i.type + i.id] = [i]), "friend" === i.type)
                    ) {
                        var s;
                ...
                if (j[i.type])
                    if ("friend" === i.type)
                        layui.each(j.friend, function(n, l) {
                            if (i.groupid == l.id)
                                return (
                                    layui.each(j.friend[n].list, function(
                                        e,
                                        t
                                    ) {
                ...
                if (!a) {
                    var s = n(
                        u({
                            ...
                            item: "d.data",
                            index:
                                "friend" === i.type ? "data.groupIndex" : null
                        })
                    ).render({ data: e });
                    if ("friend" === i.type) {
                        ...
                        o.find(".layui-layim-list").append(s),
                            o
                                .find(".layim-count")
                                .html(j.friend[i.groupIndex].list.length),
                            o.find(".layim-null")[0] &&
    ...
    .addcss("modules/layim/layim.css?v=3.7.8", "skinlayimcss");
