...
class Order_evaluate extends API_Controller {
    ...
    /**
	 * @api {get} /api/admin/order_evaluate 订单评价-列表
	 * @apiVersion 1.0.0
	...
	/**
	 * @api {get} /api/admin/order_evaluate/view 订单评价-详情
	 * @apiVersion 1.0.0
	 * @apiName order_evaluate_view
	 * @apiGroup admin
	 *
	 * @apiSampleRequest /api/admin/order_evaluate/view
	 *
	 * @apiParam {Number} admin_id 管理员唯一ID
	 * @apiParam {String} account 登录账号
	 * @apiParam {String} sign 校验签名
